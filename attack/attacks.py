...
class FGSM(AdversarialAttack):
    ...
    def _attack(self, x, y):
        ...
        value, initial_pred = self.model(x)
...
class CW2(AdversarialAttack):
    ...
    def _attack(self, x, y, num_actions):
        return self.l2adv.__call__(self.model, x, y, num_actions).to(x.device)
...
class L2Adversary:
    ...
    def __init__(self,
        ...
        :param max_steps: the maximum number of optimization steps for each
               constant :math:`c` # default max_steps=100
        :type max_steps: int
    ...
    def __call__(self, model, inputs, targets, num_classes=4):
        """
